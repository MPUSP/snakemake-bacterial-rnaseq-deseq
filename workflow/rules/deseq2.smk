quantify_biotypes = glob_wildcards("results/quantify_biotypes/{sample}.counts").sample
rule deseq2_init:
    input:
        counts_dir=expand("results/quantify_biotypes/{sample}.counts", sample= quantify_biotypes),
